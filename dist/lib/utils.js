...
function formatPrice(price, options) {
    ...
    var _a = options.currency, currency = _a === void 0 ? "NZD" : _a, _b = options.notation, notation = _b === void 0 ? "compact" : _b;
...
function constructMetadata(_a) {
    ...
    return __assign({ title: title, description: description, openGraph: {
        ...
        }, icons: icons, metadataBase: new URL("https://digitalmarketplace-production-b6b9.up.railway.app") }, (noIndex && {
        robots: {
            index: false,
            follow: false,
        },
